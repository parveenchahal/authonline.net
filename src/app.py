...
import config
from controllers import Login, Logout, GoogleSignInController, PublicCertificates, AuthOnlineToken, UserInfo
...
api.add_resource(UserInfo, '/userinfo', endpoint="oauth2_userinfo", resource_class_args=(logger, userinfo_handler,))
